...
class Book(models.Model):
    """Model representing a book data"""
    title = models.CharField(max_length=200)

    # Foreign Key used because book can only have one author, but authors acan have multiple books
    ...
    language = models.ForeignKey('Language', on_delete=models.SET_NULL, null=True, help_text='Enter the Language for the book.')
...
class BookInstance(models.Model):
    ...
    class Meta:
        ...
        permissions = (
                        ...
                        ("can_modify_book_data", "Add or modify book records and information about them"),
                    )
